...
We (the [folks at Stenography](https://www.stenography.dev/)) are on a mission to make code more accessible using machine learning. We hope you love our products and services — from the API to our extensions to the next great idea that we haven’t even thought of yet — as much as we love creating them.
...
These Terms govern your access to and use of the products and services we provide through or for [Stenography](https://www.stenography.dev/), [Stenography API](https://stenography-worker.stenography.workers.dev/), (collectively, “Services”).
...
We refer to Stenography Inc., collectively as “Stenography” or “we” throughout these Terms.
...
We haven’t reviewed, and can’t review, all of the content made available through our Services by the model (“Content”) or on websites that link to, or are linked from, our Services. We’re not responsible for any use or effects of Content or third-party websites. So, for example:
...
You can view your renewal date(s) and manage subscriptions for Stenography Paid Services by visiting your [Customer Portal](https://wordpress.com/me/purchases).

You can view your renewal date(s) and manage subscriptions for Stenography Paid Services by visiting your [Customer Portal](http://woocommerce.com/my-account/my-subscriptions/) or your [API Page](https://stenography-worker.stenography.workers.dev/). 
...
**Cancelling Automatic Renewal.** You can manage and cancel your Paid Services at the respective Service’s website. For example, you can manage all of your Stenography plans through your Stenography [Customer Portal](https://wordpress.com/me/purchases). To cancel a Stenography plan, go to your [Customer Portal](https://wordpress.com/me/purchases), click on the plan you want to cancel, then follow the instructions to cancel the subscription or turn off auto-renew.

For Stenography Paid Services, you can turn off auto-renew for each active subscription at your [Customer Portal](http://woocommerce.com/my-account/my-subscriptions/).
...
**No-Show Policy.** We may have a “no-show policy” for some Paid Services that require your participation (for example, our [Stenography Team Sessions](https://en.support.wordpress.com/concierge-support/#purchasing-a-session)). For instance, this may mean that if you don’t show up or are late for a scheduled session, you’ll still be charged and won’t be entitled to a refund.
...
Our mission is to make coding more accessible to everyone, and our Services are designed to give you control and ownership over your websites. We encourage you to express yourself freely, subject to a few requirements. In particular, you represent and warrant that your use of our Services:
...
### a. Stenography-worker.stenography.workers.dev Websites and Accounts

[Stenography API](https://stenography-worker.stenography.workers.dev/) enables you to call Stenography directly, and we would love for you to use it. A WordPress.com account also allows you to sign into some of our other Services.
...
### b. Stenography Chrome Extension
...
The Agreement doesn’t transfer any Stenography or third-party intellectual property to you, and all right, title, and interest in and to such property remains (as between Stenography and you) solely with Stenography. Stenography, Stenography Chrome Extension, Stenography API, Stenography Discord Bot, Stenography Slack Bot, Stenography VSC, and all other trademarks, service marks, graphics, and logos used in connection with our websites or Services are trademarks or registered trademarks of Stenography (or Stenography’s licensors). Other trademarks, service marks, graphics, and logos used in connection with our Services may be the trademarks of other third parties. Using our Services doesn’t grant you any right or license to reproduce or otherwise use any Automattic or third-party trademarks.
...
* Third-Party Services aren’t vetted, endorsed, or controlled by Stenography.
...
Our Services are provided “as is.” Stenography and its suppliers and licensors hereby disclaim all warranties of any kind, express or implied, including, without limitation, the warranties of merchantability, fitness for a particular purpose and non-infringement. Neither Stenography, nor its suppliers and licensors, makes any warranty that our Services will be error free or that access thereto will be continuous or uninterrupted. If you’re reading this, thank you :). You understand that you download from, or otherwise obtain content or services through, our Services at your own discretion and risk.
